...
info "Enabling pipewire via user dinit..."
...
echo -e "${GREEN}${BOLD}║  3. Open protonup-qt → install latest Proton-GE              ║${RESET}"
echo -e "${GREEN}${BOLD}║  4. Open Steam → enable Proton-GE as compatibility layer     ║${RESET}"
echo -e "${GREEN}${BOLD}║  5. Add a wallpaper to ~/.config/hypr/wallpapers/wall.jpg    ║${RESET}"
echo -e "${GREEN}${BOLD}║  6. Run: radeontop   to verify GPU is active                 ║${RESET}"
echo -e "${GREEN}${BOLD}║  7. Run: vulkaninfo --summary   to verify RADV               ║${RESET}"
echo -e "${GREEN}${BOLD}╚══════════════════════════════════════════════════════════════╝${RESET}"
echo
